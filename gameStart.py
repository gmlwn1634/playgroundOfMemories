...
def run():
    ...
    def mainmenu():
        ...
        while menu:
            ...
            GameBtn(shootingBtn, 312, 170, 198, 119, shootingBtn2, 325, 175, shootingRun)
            GameBtn(flappyBtn, 515, 170, 198, 119, flappyBtn2, 525, 175, flappyRun)
            GameBtn(rabbitBtn, 715, 170, 198, 119, rabbitBtn2, 725, 175, rabbitRun)
